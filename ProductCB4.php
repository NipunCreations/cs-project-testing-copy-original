...
<div class="productsection" align="center">
           <div class="container-fluid" style="width:1450px;" align="center">  
            ...
            <div class="col-2">
                <h1 style="color:rgb(11, 110, 24);">Vegetables<br>  
                ...
                <div class="tab-content">  
                     ...
                     <div class="col-md-2" style="margin-top:5px;">  
                          <div style="  background-color:white;  padding:18px; height:400px;" align="center">  
                               <img src="images/Vegetables/<?php echo $row["image"]; ?>" class="img-responsive" /><br />  
                             <h4 class="text-danger"> <a href="productdetails.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?></a></h4>  
