...
<body style="margin-top: -20px ">
	...
	$result = mysqli_query($conn,"SELECT * FROM cookingessential WHERE id='" . $id."'");
        ...
        <div class="container single-product" style="margin-top: -20px">
            <div class="row">
                <div class="col-2">
                    ...
                    <img src="images/Cooking Essential/<?php echo $image ; ?>" width="300px" height="300px">
                </div>
                <div class="col-2">
                    ...
                    <br>
                    <p
                        style="font-size: 20px; font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif'">
                        <?php echo $details ; ?></p>
                </div>
            </div>
        </div>
