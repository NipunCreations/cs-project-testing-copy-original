            ...
            <div class="navbar">
                ...
                <nav>
                    <ul
                        ...
                        <li><a class="active" href="products2.php">Cookingessential</a></li>
        ...
        <div class="productsection" align="center">
            <div class="container-fluid" style="width:1450px;" align="center">
                <div class="tab-content">
                    ...
                    <div id="cookingessential" class="tab-pane fade in active">
                        <?php  
                     ...
                     ?>
                        <div class="col-md-2" style="margin-top:12px;">
                            <div style="border:1px solid #333; background-color:#f1f1f7; border-radius:5px; padding:20px; height:400px;"
                                align="center">
                                <img src="images/Cooking Essential/<?php echo $row["image"]; ?>"
                                    class="img-responsive" /><br />
                                <a
                                    href="productdetails2A.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?></a>
                                </h4>
