...
<li>  <a class="active" href="orderItems.php">Order Details</a></li>
	...
	<table class="table table-striped table-hover" align="center" style="margin-top: ">
   <thead >
    <tr>
  ...
  <tbody align="center" style="font-size: 20px">
	 ...
	 ?> 
	   ...
	   <tr>
	   <th align="left" style="background-color: azure; color: black" scope="col">My ID</th>	
	      <td><?php echo $id ?></td>
	   </tr>
	     <tr>
	   <th style="background-color: azure; color: black" scope="col">Name</th>	
	      <td><?php echo $CustomerName ?></td>
	   </tr>
	     <tr>
	   <th  style="background-color: azure; color: black" scope="col">Address</th>	
	      <td><?php echo $Address ?></td>
	   </tr>
	     <tr>
	   <th  style="background-color: azure; color: black" scope="col">City</th>	
	      <td><?php echo $City ?></td>
	   </tr>
	     <tr>
	   <th style="background-color: azure; color: black" scope="col">Postal Code</th>	
	      <td><?php echo $PostalCode ?></td>
	   </tr>
         <tr>
	   <th style="background-color: azure; color: black" scope="col">Country</th>	
	      <td><?php echo $Country ?></td>
	   </tr>
	     <tr>
	   <th style="background-color: azure; color: black" scope="col">Email</th>	
	      <td><?php echo $Email ?></td>
	   </tr>
	   <tr>
	   <th style="background-color: azure; color: black" scope="col">Password</th>	
