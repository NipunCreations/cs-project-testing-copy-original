...
$result = mysqli_query($connect, "SELECT SUM(product_price*product_quantity) as average FROM tbl_order_details");
$row = mysqli_fetch_array($result);
$average = $row['average'];

$result2 = mysqli_query($connect, "SELECT * FROM tbl_sales WHERE id = 100010001");
...
$a = [$year2019, $year2020, $year2021, $year2022, $year2023, $year2024, $year2025, $year2026];
$a = array_filter($a);
    ...
    <div class="header">
        <div class="container">
            <div class="navbar">
                ...
                <nav>
                    <ul style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif';font-size: 18px">
                        ...
                        <li>
                            <a class="" style="border-radius: 30px;transition: background 0.5s;display: inline-block;padding: 8px 20px;margin:15px 0;">
                                <i class="fa fa-user-circle"></i> Admin <?php echo $name; ?>
                            </a>
                        </li>
                        <li>
                            <a class="" style="border-radius: 30px;transition: background 0.5s;display: inline-block;padding: 8px 20px;margin: 15px 0;" href="userLogout.php">
            ...
            <div style="overflow-y: scroll">
                Current Date: <input type="text" id="currentDate" readonly>
                <script>
                    var today = new Date();
                    var date = today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate();
                    document.getElementById("currentDate").value = date;
                </script>
                <?php echo "<h1>" . date("Y") . "Total Sales Turnover: Rs $average </h1>"; ?>
        ...
        <div class="small-container">
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <p>Enjoy the same lowest prices as your local Online Express supermarket, Express & Food Hall store</p>
