  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
		...
		<form method="post" action="bavarages_update.php"  enctype="multipart/form-data"> 	
...
<table class="table table-striped table-hover" id="user-data">
  ...
  <tbody>
    ...
    <tr>
		 ...
		 <td><img width="35px" height="35px" src="images/Baverages/<?php echo $row['image']; ?>"</td>
...
<td><a href="bavarages_manage.php?delete= <?php echo $row['id']; ?> " class="btn btn-danger btn-lg"><i class="fa fa-trash"></a></td>
