<?php   
 session_start();  
 $connect = mysqli_connect("db-mysql-nyc3-95016-do-user-18344030-0.i.db.ondigitalocean.com:25060", "doadmin", "AVNS_bCii5x9geE9Vu7OomJJ", "defaultdb");  include "DBconnection.php";  
            ...
            <div class="navbar">
                ...
                <nav>
                    <ul
                        ...
                        <li><a class="btn btn-default" href="customerprofile.php"> <i
                                    class="fa fa-user-circle"></i>&nbsp; <?php echo $name;?></a> </li>
                        <li><a class="btn btn-info" href="userLogout.php">Log Out &nbsp;<i
        ...
        <div class="productsection" align="center">
            <div class="container-fluid" style="width:1450px;" align="center">
                <div class="tab-content">
                    <div id="baverages" class="tab-pane fade in active">
                        <?php  
                     ...
                     ?>
                        <div class="col-md-2" style="margin-top:12px;">
                            <div style="border:1px solid #333; background-color:#f1f1f7; border-radius:5px; padding:20px; height:400px;"
                                align="center">
                                <img src="images/Baverages/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
                                <a
                                    href="productdetails1A.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?></a>
                                </h4>
                                <h4 class="text-danger">Rs.<?php echo $row["price"]; ?></h4>

                                <input type="text" name="quantity" id="quantity<?php echo $row["id"]; ?>"
                                ...
                                <input type="button" name="add_to_cart" id="<?php echo $row["id"]; ?>"
                                    style="margin-top:5px;" class="btn btn-warning form-control add_to_cart"
                                    value="Add to Cart" />
                            </div>
                        </div>
                        <?php  
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <p>
                    Enjoy the same lowest prices as your local Online ExpresOnline Express supermarket, Express & Food
                    Hall store</p>
