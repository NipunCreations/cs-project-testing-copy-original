	...
	<div id="model" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  		<div class="modal-dialog" role="document">
        		...
        		<h4 class="modal-title" id="exampleModalLabel1">Add Items</h4>	
				 ...
				 <hr>
	<form method="post" action="fruits_manage.php"  enctype="multipart/form-data"> 		
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
		...
		<form method="post" action="fruits_update.php"  enctype="multipart/form-data"> 	
...
<table class="table table-striped table-hover" id="user-data">
  ...
  <tbody>
    ...
    <tr>
		 ...
		 <td><img width="35px" height="35px" src="images/Fruits/<?php echo $row['image']; ?>"</td>
...
<td><a href="fruits_manage.php?delete= <?php echo $row['id']; ?> " class="btn btn-danger btn-lg"><i class="fa fa-trash"></a></td>
