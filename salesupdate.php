    ...
    <div class="header">
        ...
        <div class="container">
            ...
            <div style="overflow-y: scroll">
                ...
                <!-- insert model -->
                <div id="model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                                ...
                                <form method="post" action="bavarages_manage.php" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="submit" class="btn btn-success" />Insert
                                            Data</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" name="id" id="id" class="form-control" placeholder="ID"
                                        readonly />
                                    <br>
                                    <input type="text" name="year2019" id="year2019" class="form-control"
                                        placeholder="2019" />
                                    <br>
                                    <input type="text" name="year2020" id="year2020" class="form-control"
                                        placeholder="2020" />
                                    <br>
                                    <input type="text" name="year2021" id="year2021" class="form-control"
                                        placeholder="2021" />
                                    <br>
                                    <input type="text" name="year2022" id="year2022" class="form-control"
                                        placeholder="2022" />
                                    <br>
                                    <input type="text" name="year2023" id="year2023" class="form-control"
                                        placeholder="2023" />
                                    <br>
                                    <input type="text" name="year2024" id="year2024" class="form-control"
                                        placeholder="2024" />
                                    <br>
                                    <input type="text" name="year2025" id="year2025" class="form-control"
                                        placeholder="2025" />
                                    <br>
                                    <input type="text" name="year2026" id="year2026" class="form-control"
                                        placeholder="2026" />


                                    <div class="modal-footer">
                                        <button type="submit" value="submit" id="update_id" name="updatedata"
 		...
 		while ($row= $result->fetch_assoc()):  ?>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-danger btn-xs editbtn"><i
                                            class="fa fa-balance-scale" aria-hidden="true"></i></button></td>
