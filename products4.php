            ...
            <div class="navbar">
                ...
                <nav>
                    <ul
                        ...
                        <li><a class="active" href="products4.php">Vegetables</a></li>
                     ...
                     ?>
                        <div class="col-md-2" style="margin-top:12px;">
                            <div style="border:1px solid #333; background-color:#f1f1f7; border-radius:5px; padding:20px; height:400px;"
                                align="center">
                                <img src="images/Vegetables/<?php echo $row["image"]; ?>"
                                    class="img-responsive" /><br />
                                <a
                                    href="productdetailsA.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?></a>
                                </h4>
